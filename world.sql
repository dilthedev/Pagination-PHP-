...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2017 at 08:12 PM
...
INSERT INTO `city` (`city_id`, `city_name`, `country_code`, `province`, `population`) VALUES
...
CREATE TABLE `country` (
  ...
  `govt_form` char(45) NOT NULL DEFAULT '',
...
INSERT INTO `country` (`id`, `country_code`, `country_name`, `continent`, `region`, `surface_area`, `indep_year`, `population`, `life_expectancy`, `gnp`, `gnp_old`, `local_name`, `govt_form`, `head_of_state`, `capital`, `code_2`) VALUES
...
(125, 'LKA', 'Sri Lanka', 'Asia', 'Southern and Central Asia', 65610.00, 1948, 18827000, 71.8, 15706.00, 15091.00, 'Sri Lanka', 'Republic', 'Mahinda Rajapakse', 3217, 'LK'),
...
INSERT INTO `language` (`country_code`, `language`, `percentage`) VALUES
('ABW', 'Dutch', 5.3),
('ABW', 'English', 9.5),
('ABW', 'Papiamento', 76.7),
('ABW', 'Spanish', 7.4),
